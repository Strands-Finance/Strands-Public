...
export interface DirectInputBookKeeperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_checkExpectedNAV"
      | "acceptOwnership"
  ...
  encodeFunctionData(
    functionFragment: "markValueOutsideRepository18",
...
export interface DirectInputBookKeeper extends BaseContract {
  connect(runner?: ContractRunner | null): DirectInputBookKeeper;
  waitForDeployment(): Promise<this>;

  interface: DirectInputBookKeeperInterface;
  ...
  markValueOutsideRepository18: TypedContractMethod<
    [value: BigNumberish, validFor: BigNumberish, expectedNAV: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[expectedNAV: BigNumberish], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "markValueOutsideRepository18"
  ): TypedContractMethod<
    [value: BigNumberish, validFor: BigNumberish, expectedNAV: BigNumberish],
    [void],
    "nonpayable"
