...
export interface TestERC20SetDecimalsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TestERC20SetDecimals extends BaseContract {
  connect(runner?: ContractRunner | null): TestERC20SetDecimals;
  waitForDeployment(): Promise<this>;

  interface: TestERC20SetDecimalsInterface;
  ...
  permitMint: TypedContractMethod<
    [user: AddressLike, permit: boolean],
    [void],
    "nonpayable"
  >;
