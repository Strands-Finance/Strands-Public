...
export interface S1PositionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "approve"
...
export interface S1Position extends BaseContract {
  connect(runner?: ContractRunner | null): S1Position;
  waitForDeployment(): Promise<this>;

  interface: S1PositionInterface;
  ...
  getValue: TypedContractMethod<[tokenId: BigNumberish], [bigint], "view">;
  ...
  setValue: TypedContractMethod<
    [tokenId: BigNumberish, _value: BigNumberish],
    [void],
    "nonpayable"
  >;
