...
export declare namespace DepositAccount {
...
export interface DepositAccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "getOwnerAccount",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "getOwnerAccountDetails",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface DepositAccount extends BaseContract {
  connect(runner?: ContractRunner | null): DepositAccount;
  ...
  getBalance: TypedContractMethod<
    [bank_: string, accountNumber_: string],
    [bigint],
    "view"
  >;

  getOwnerAccount: TypedContractMethod<
    [target: AddressLike],
    [bigint[]],
    "view"
  >;

  getOwnerAccountDetails: TypedContractMethod<
    [target: AddressLike],
    [DepositAccount.AccountDetailsStructOutput[]],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getOwnerAccount"
  ): TypedContractMethod<[target: AddressLike], [bigint[]], "view">;
  getFunction(
    nameOrSignature: "getOwnerAccountDetails"
  ): TypedContractMethod<
    [target: AddressLike],
    [DepositAccount.AccountDetailsStructOutput[]],
    "view"
