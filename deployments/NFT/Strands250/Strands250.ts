...
export interface Strands250Interface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "adminSelfBatchMint",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setIndividualize",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface Strands250 extends BaseContract {
  connect(runner?: ContractRunner | null): Strands250;
  waitForDeployment(): Promise<this>;

  interface: Strands250Interface;
  ...
  adminSelfBatchMint: TypedContractMethod<
    [num: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setFeeAmount: TypedContractMethod<
  ...
  setIndividualize: TypedContractMethod<[i: boolean], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "adminSelfBatchMint"
  ...
  getFunction(
    nameOrSignature: "setIndividualize"
  ): TypedContractMethod<[i: boolean], [void], "nonpayable">;
  getFunction(
