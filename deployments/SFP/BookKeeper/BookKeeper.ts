...
export interface SimpleBookKeeperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_checkExpectedNAV"
      | "acceptOwnership"
...
export interface SimpleBookKeeper extends BaseContract {
  connect(runner?: ContractRunner | null): SimpleBookKeeper;
  waitForDeployment(): Promise<this>;

  interface: SimpleBookKeeperInterface;
